 ...
 */
public class garagerecent extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_garagerecent, container, false);

        sessionManager1=new SessionManager1(getActivity());
        id=sessionManager1.getapidata();
        recyclerView=(RecyclerView)v.findViewById(R.id.recycleGarageRecent);
                    ...
                    try {
                       ...
                       Historyresponse historyresponse=new Historyresponse(String.valueOf(object.getInt("id")),String.valueOf("user_id"),
                        ...
                        UserRecent userRecent=new UserRecent("Vehicle Service Booking",historyresponse.getCreatedAt(),historyresponse.getUsername(),historyresponse.getServicetype()+" service of "+
                                    historyresponse.getVehicletype()+"booked",historyresponse.getPhone(),String.valueOf(historyresponse.getLatitude()),String.valueOf(historyresponse.getLongitude()));
